...
class ACT:
    ...
    def pred_obj_llm(self):
        ...
        while not conv_flag:
            ...
            for obj in obj_ref.keys():
                if not obj in t_obj['content'].keys():
                    t_obj['content'][obj] = "D"
        ...
        dir_name = './Result' + output_type + '/LLM/pred_obj_llm_{:0=3}'.format(self.scene_id)
    ...
    def pred_obj_traj(self):
        ...
        dir_name = './Result' + output_type + '/TRAJ/pred_obj_traj_{:0=3}'.format(self.scene_id)
        file_name = '/map_predobj_'+ f'{self.scene_id:03}_' + f'{self.act_id:03}_' + f'{self.n_act:03}_' + f'{self.t_act:03}' + '.png'
